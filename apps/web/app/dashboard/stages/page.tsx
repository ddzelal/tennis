...
export default function StagesPage() {
        ...
        return (
            <div className="p-4 lg:p-8 space-y-6 min-h-screen bg-gray-50">
                <div className="bg-red-50 border border-red-200 rounded-xl p-8 text-center">
                    <h2 className="text-lg font-semibold text-red-800 mb-2">Error Loading Stages</h2>
                    <p className="text-red-600 mb-4">Failed to load stages data: {error.message}</p>
                    <button
                        onClick={() => refetch()}
    ...
    const filteredStages = stages.filter(stage => {
        ...
        const matchesTournament = tournamentFilter === 'all' ||
            (typeof stage.tournament === 'object' && stage.tournament._id === tournamentFilter);
    ...
    const stats = {
        ...
        newThisMonth: stages.filter(s => {
            ...
            return stageDate.getMonth() === thisMonth.getMonth() &&
        ...
        <div className="p-4 lg:p-8 space-y-6 min-h-screen bg-gray-50">
            ...
            <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-2xl p-6 text-white">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        <h1 className="text-2xl lg:text-3xl font-bold mb-2">Stage Management 🎭</h1>
            ...
            {isLoading ? (
                ...
                <div className="bg-white rounded-xl p-8 text-center">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">
                        {searchQuery || typeFilter !== 'all' || tournamentFilter !== 'all' ? 'No stages found' : 'No stages yet'}
                    </h3>
