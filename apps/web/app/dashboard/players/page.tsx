...
export default function PlayersPage() {
        ...
        return (
            <div className="p-4 lg:p-8">
                <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
                    ...
                    <p className="text-red-600 mb-4">Failed to load players data: {error.message}</p>
                    <button
                        onClick={() => refetch()}
    ...
    const stats = {
        ...
        newThisMonth: players.filter(p => {
            ...
            return playerDate.getMonth() === thisMonth.getMonth() &&
        ...
        <div className="p-4 lg:p-8 space-y-6 min-h-screen bg-gray-50">
            ...
            <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-2xl p-6 text-white">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        <h1 className="text-2xl lg:text-3xl font-bold mb-2">Players Management 🎾</h1>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                    ...
                    <h3 className="text-2xl font-bold text-gray-900">{stats.topRanked}</h3>
