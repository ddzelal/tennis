...
export default function TournamentsPage() {
    ...
    const { data: tournamentsResponse, isLoading, error, refetch } = useGetTournaments({
        search: searchTerm,
        ...
        return (
            <div className="p-4 lg:p-8">
                <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
                    ...
                    <p className="text-red-600 mb-4">Failed to load tournaments data: {error.message}</p>
                    <button
                        onClick={() => refetch()}
    ...
    const stats = {
        ...
        completed: tournaments.filter(t => t.status === TournamentStatus.COMPLETED).length,
        newThisMonth: tournaments.filter(t => {
            const tournamentDate = new Date(t.createdAt || Date.now());
            const thisMonth = new Date();
            return tournamentDate.getMonth() === thisMonth.getMonth() &&
        ...
        <div className="p-4 lg:p-8 space-y-6 min-h-screen bg-gray-50">
            ...
            <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-2xl p-6 text-white">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        <h1 className="text-2xl lg:text-3xl font-bold mb-2">Tournament Management 🏆</h1>
