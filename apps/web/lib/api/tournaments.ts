...
export const tournamentsApi = {
  ...
  getPlayersInTournament: async (
    tournamentId: string,
  ): Promise<GetPlayersByTournamentId> => {
    return api.get<GetPlayersByTournamentId>(
      `${ENDPOINT.TOURNAMENT(tournamentId)}/players`,
    );
  },
