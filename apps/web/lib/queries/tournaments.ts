...
export const useCreateTournament = (
  ...
  return useMutation({
    ...
    onSuccess: async (
      ...
      variables: CreateTournamentData,
      context?: any,
    ) => {
      try {
...
export const useUpdateTournament = (
  options?: UseMutationOptions<
    Tournament,
    Error,
    { id: string; data: UpdateTournamentData }
  >,
) => {
  const queryClient = useQueryClient();
  ...
  return useMutation({
    ...
    onSuccess: async (
      ...
      variables: { id: string; data: UpdateTournamentData },
      context?: any,
    ) => {
      try {
        queryClient.setQueryData(
          tournamentKeys.detail(variables.id),
          updatedTournament,
        );
...
export const useAddPlayerToTournament = (
  ...
  return useMutation({
    ...
    onSuccess: (data, variables) => {
      queryClient.setQueryData(
        tournamentKeys.detail(variables.tournamentId),
        data,
      );
      queryClient.invalidateQueries({
        queryKey: tournamentKeys.lists(),
