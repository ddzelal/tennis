...
export const DeleteTournamentModal: React.FC<DeleteTournamentModalProps> = ({
  ...
  const playersCount = Array.isArray(tournament.players)
          ...
          {isActiveTournament && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
              ...
              <p className="text-sm text-yellow-700">
                ...
                {tournament.status.toLowerCase().replace("_", " ")}. Deleting it
                will affect all registered players and ongoing matches.
              </p>
            </div>
          )}
          ...
          <div className="px-6 pb-6">
            <div className="bg-red-50 border border-red-200 rounded-lg p-3">
              <p className="text-sm text-red-600 flex items-center">
                ...
                Failed to delete tournament. Please try again or contact support
