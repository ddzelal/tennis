              ...
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center space-x-2 mt-1">
                    {player.ranking ? (
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium ${getRankingColor(player.ranking)}`}
                      >
      ...
      {players.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 max-w-sm mx-auto">
            No players match your current search and filter criteria. Try
            adjusting your filters or add some new players.
          </p>
        </div>
      )}
