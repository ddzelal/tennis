...
type SortField = 'name' | 'type' | 'order' | 'tournament' | 'players' | 'startDate' | 'endDate' | 'createdAt';
type SortDirection = 'asc' | 'desc';

export const StageTable: React.FC<StageTableProps> = ({ stages, onRefresh }) => {
    ...
    const sortedStages = [...stages].sort((a, b) => {
        ...
        switch (sortField) {
            ...
            case 'order':
                ...
                break;
            case 'tournament':
                aValue = typeof a.tournament === 'object' ? a.tournament.name.toLowerCase() : '';
                bValue = typeof b.tournament === 'object' ? b.tournament.name.toLowerCase() : '';
                break;
            case 'players':
                ...
                <div className="overflow-x-auto">
                    <table className="w-full">
                        ...
                        {sortedStages.map((stage) => {
                            ...
                            return (
                                <tr key={stage._id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${getStageTypeColor(stage.type)}`}>
