                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      {player.ranking ? (
                        <span
                          className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getRankingColor(player.ranking)}`}
                        >
                          <Trophy size={12} className="mr-1" />#{player.ranking}
                        </span>
                      ) : (
