      ...
      <div className="bg-white rounded-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="px-6 py-4 bg-gray-50 border-b border-gray-100">
          <div className="flex items-center space-x-4">
            ...
            <div
              className={`h-px flex-1 ${currentStep >= 2 ? "bg-green-600" : "bg-gray-200"}`}
            ></div>
            <div
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, gamesPerSet: e.target.value })
                    }
                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition-colors ${
                      errors.gamesPerSet
                        ? "border-red-300 bg-red-50"
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, pointsPerWin: e.target.value })
                    }
                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition-colors ${
                      errors.pointsPerWin
                        ? "border-red-300 bg-red-50"
            ...
            {currentStep === 1 ? (
              <>
                ...
                <button
                  ...
                  onClick={handleNext}
                  disabled={
                    createTournamentMutation.isPending || !formData.name.trim()
                  }
          ...
          <div className="px-6 pb-6">
            <div className="bg-red-50 border border-red-200 rounded-lg p-3">
              <p className="text-sm text-red-600 flex items-center">
                ...
                Failed to create tournament. Please check your input and try
                again.
              </p>
            </div>
          </div>
