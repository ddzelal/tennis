...
import { X, User, Calendar, Trophy, Info, CheckCircle, Edit } from 'lucide-react';
            ...
            <div className="bg-white rounded-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-200">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">Update player information</p>
                    </div>
                    <button
                        onClick={handleClose}
                ...
                {previewName && (
                    <div className="px-6 py-4 bg-green-50 border-b border-green-100">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <h3 className="font-medium text-gray-900">Preview: {previewName}</h3>
                                {age && (
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="flex space-x-3 pt-4">
                        ...
                        <button
                            type="submit"
                            disabled={updatePlayerMutation.isPending || !formData.firstName?.trim() || !formData.lastName?.trim() || !formData.dateOfBirth}
