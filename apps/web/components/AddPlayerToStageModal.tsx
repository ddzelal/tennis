            ...
            <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-200">
                    <div className="flex items-center space-x-3">
                        ...
                        <h2 className="text-xl font-semibold text-gray-900">Add Players to Stage</h2>
                    </div>
                    <button
                        onClick={onClose}
                            ...
                            <div className="text-center py-8">
                                {availablePlayers.length === 0 ? (
                                    <>
                                        ...
                                        <p className="text-gray-500">No available players to add to this stage.</p>
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="flex items-center space-x-4 text-sm text-gray-500">
                                                {player.ranking && (
                                                    <span className="flex-shrink-0">Rank #{player.ranking}</span>
                                                )}
                                            </div>
                                        </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-end space-y-3 sm:space-y-0 sm:space-x-3 pt-6 border-t border-gray-200">
                        ...
                        >
                            {addPlayerMutation.isPending ? (
                                ...
                                <>
                                    <Plus size={16} />
                                    <span>Add {selectedPlayers.length} Player{selectedPlayers.length !== 1 ? 's' : ''}</span>
                                </>
                            )}
                        </button>
                    </div>
