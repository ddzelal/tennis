        ...
        return (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100">
                <div className="p-8 text-center">
                    ...
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Error Loading Tournaments</h3>
                    <p className="text-red-500">Failed to load tournaments. Please try again.</p>
                </div>
            </div>
        );
    }
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100">
                <div className="p-8 text-center">
                    ...
                    <p className="text-gray-500">
                        {searchTerm ? 'Try adjusting your search criteria' : 'Create your first tournament to get started'}
                    </p>
                </div>
            </div>
        );
        ...
        <>
            ...
            <div className="lg:hidden space-y-4">
                {tournaments.map((tournament) => (
                    <div key={tournament._id} className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
                            ...
                            <div className="flex items-center space-x-3 flex-1">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    {tournament.description && (
                                        <p className="text-sm text-gray-500 truncate">{tournament.description}</p>
                                    )}
                                </div>
                            </div>
                            <div className="relative">
                                <button
                                    onClick={() => setOpenDropdown(openDropdown === tournament._id ? null : tournament._id)}
