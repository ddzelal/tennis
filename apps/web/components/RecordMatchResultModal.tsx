...
import { X, Trophy, Target, CheckCircle, AlertCircle, Clock } from 'lucide-react';
...
export const RecordMatchResultModal: React.FC<RecordMatchResultModalProps> = ({
    ...
    const recordResultMutation = useRecordMatchResult({
        ...
        onError: (error: any) => {
            ...
            setErrors({
                general: error.response?.data?.message || 'Failed to record match result'
            });
        }
    });
    ...
    const calculateWinner = (): string => {
        ...
        if (player1Sets >= 2) {
            return typeof match.player1 === 'object' ? match.player1._id : match.player1;
        }
        if (player2Sets >= 2) {
            return typeof match.player2 === 'object' ? match.player2._id : match.player2;
        }
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            <div className="text-center">
                                ...
                                <p className="text-sm font-medium mt-1">{getPlayerName(player1)}</p>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-sm font-medium mt-1">{getPlayerName(player2)}</p>
                            </div>
                        </div>
                        {match.scheduledDate && (
                        ...
                        <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                            <div className="flex items-center space-x-2">
                                ...
                                <span className="font-medium text-green-800">
                                    Winner: {winner === (typeof match.player1 === 'object' ? match.player1._id : match.player1)
