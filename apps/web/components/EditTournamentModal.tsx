...
import { X, Trophy, Calendar, Users, Info, Save, FileText, Settings } from 'lucide-react';
import { TournamentType, TournamentStatus, UpdateTournamentData, Tournament } from '@repo/lib';
    ...
    useEffect(() => {
        if (tournament && isOpen) {
            setFormData({
                ...
                startDate: tournament.startDate ? (String(tournament.startDate).split('T')?.[0] ?? '') : '',
                endDate: tournament.endDate ? (String(tournament.endDate).split('T')?.[0] ?? '') : '',
                maxPlayers: tournament.maxPlayers ? tournament.maxPlayers.toString() : '',
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value={TournamentStatus.REGISTRATION}>Registration</option>
                            ...
                            <div className="space-y-6">
                                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                                    ...
                                    <p className="text-sm text-blue-700">
                                        Configure how matches will be played and scored in this tournament
                                    </p>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        />
                                        {errors.setsToWin && (
                                            <p className="text-red-600 text-xs mt-1">{errors.setsToWin}</p>
                                        )}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        />
                                        {errors.gamesPerSet && (
                                            <p className="text-red-600 text-xs mt-1">{errors.gamesPerSet}</p>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div>
                                    <label className="flex items-center space-x-2">
                                        ...
                                        />
                                        <span className="text-sm font-medium text-gray-700">Enable Tiebreak</span>
                                    </label>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        />
                                        {errors.pointsPerWin && (
                                            <p className="text-red-600 text-xs mt-1">{errors.pointsPerWin}</p>
                                        )}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        {errors.pointsPerLoss && (
                                            <p className="text-red-600 text-xs mt-1">{errors.pointsPerLoss}</p>
                                        )}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        {errors.pointsPerDraw && (
                                            <p className="text-red-600 text-xs mt-1">{errors.pointsPerDraw}</p>
                                        )}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="flex space-x-3">
                            ...
                            {currentStep === 1 ? (
                                ...
                                <button
                                    ...
                                    disabled={updateTournamentMutation.isPending || !formData.name.trim()}
                    ...
                    <div className="px-6 pb-6">
                        <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                            <p className="text-sm text-red-600 flex items-center">
                                ...
                                Failed to update tournament. Please check your input and try again.
                            </p>
                        </div>
                    </div>
                )}
