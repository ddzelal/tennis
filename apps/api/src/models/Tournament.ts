...
import { ITournamentDocument, TournamentType, TournamentStatus, TournamentSettings } from '@repo/lib';
...
TournamentSchema.pre('save', function() {
    ...
    if (this.maxPlayers && this.players && this.players.length > this.maxPlayers) {
        throw new Error(`Cannot exceed maximum players limit of ${this.maxPlayers}`);
    }
});
