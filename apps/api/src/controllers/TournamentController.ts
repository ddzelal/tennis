...
export const TournamentController = {
    ...
    getPlayersInTournament : (async (req: Request, res: Response<GetPlayersByTournamentId>): Promise<void> => {
        try {
          ...
          const players = tournament.players || [];
            ...
            return ResponseHelper.success(res, players, `Found ${players.length} player(s) in tournament`);
